const fetch = require('node-fetch'),
    ...
    admins = ["318063295573524483", "yourid", "yourid"],
    config = {
        "833471402437902377": 175,
        "833471425276543066": 250,
        "833471440522444820": 400,
        "833471584407650384": 750,
        "833471516892987422": 1000,
        "833471543245013042": 2500,
        "833852747538235452": 3500,
        "834061725728899133": 50
    }
...
client.on('message', async (message) => {
    ...
    if (command === "tfollow") {
        let twitchID = "833483848347287562";
...
client.login("ODMzODQ2ODc2MDc5MjU5NjY5.YH4Saw.lR7swKaU2zP8OnUWckXwOGPvdFU")
